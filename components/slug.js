    ...
    return(
        <div className="mt-4">
            ...
            <Collapse title="Détails de la propriété">
                <section className="mt-3 pl-3">
                    <div>
                        <span className="font-weight-bolder">Surface</span> : {property.surface} m²
                    </div>
                    <div>
                    ...
                    <div>
                        <span className="font-weight-bolder">Date de création</span> : <Moment format="DD/MM/YYYY à hh:mm:ss">{property.createdAt}</Moment>
                    </div>
                </section>
            </Collapse>
            <style jsx>
